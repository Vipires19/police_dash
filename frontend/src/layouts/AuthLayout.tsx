    ...
    <div className="min-h-screen bg-gradient-to-b from-black via-zinc-950 to-zinc-950 text-zinc-100">
      <div className="mx-auto flex min-h-screen max-w-md flex-col justify-center px-4 py-12">
        <div className="mb-8 text-center">
          ...
          <h1 className="mt-2 text-2xl font-semibold text-zinc-100">1° Pel Força Tática/ROCAM</h1>
          <p className="mt-2 text-sm text-zinc-400">Ambiente interno — autenticação obrigatória</p>
        </div>
